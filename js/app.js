(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".advice-service__slider")) new core(".advice-service__slider", {
        ...
        if (document.querySelector(".about-us__slider")) new core(".about-us__slider", {
...
***************************************************************************** */
    ...
    ymaps.ready((function() {
        ...
        control.routePanel.state.set({
            type: "pedestrian",
            fromEnabled: true,
            from: "Казань, кремлевкая 2",
            to: "Казань, адоратского 3г ",
            toEnabled: false
        });
